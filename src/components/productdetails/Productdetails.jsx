...
class Productdetails extends Component {
    ...
    render() {
     ...
     const View=AllData.map((Data,i)=>{
          return (
               <Col key={i.toString()} className="shadow-sm bg-white pb-3 mt-4" md={12} lg={12} sm={12} xs={12}>
     <Row>
          <Col  className="p-3" md={6} lg={6} sm={12} xs={12}>
          <img alt='' className="w-100" src={Data.image} />
          ...
          <div className="input-group">
               ...
               <div className="Product-price-card d-inline ">New Price {Data.price}</div>
          </div>
